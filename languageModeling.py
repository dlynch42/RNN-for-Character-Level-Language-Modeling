...
# 2) Reshape into batches of sequences
...
# 9) Create and train CharRNN Model
batch_size = 64
num_steps = 100
...
rnn.train(train_x, train_y,
            num_epochs=100,
            ckpt_dir='./model-100/')    # saved in dictionary './model-100/'

# 10) CharRNN Model in Sampling Mode
